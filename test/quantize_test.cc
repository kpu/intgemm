...
TEST_CASE("QuantizeStd SSSE3", "[VectorMeanStd]") {
  ...
  testVectorMeanStd<SSE2::VectorMeanStd>(133);
  testVectorMeanStd<SSE2::VectorMeanStd>(133, true);
  ...
  testVectorMeanStd<SSE2::VectorMeanStd>(2931);
  testVectorMeanStd<SSE2::VectorMeanStd>(2931, true);
...
TEST_CASE("QuantizeStd AVX2", "[VectorMeanStd]") {
  ...
  testVectorMeanStd<AVX2::VectorMeanStd>(133);
  testVectorMeanStd<AVX2::VectorMeanStd>(133, true);
  ...
  testVectorMeanStd<AVX2::VectorMeanStd>(2931);
  testVectorMeanStd<AVX2::VectorMeanStd>(2931, true);
...
TEST_CASE("QuantizeStd AVX512BW", "[VectorMeanStd]") {
  ...
  testVectorMeanStd<AVX512BW::VectorMeanStd>(133);
  testVectorMeanStd<AVX512BW::VectorMeanStd>(133, true);
  ...
  testVectorMeanStd<AVX512BW::VectorMeanStd>(2931);
  testVectorMeanStd<AVX512BW::VectorMeanStd>(2931, true);

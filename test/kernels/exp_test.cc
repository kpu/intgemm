...
TEST_CASE("Kernel: exp_approx_taylor AVX2",) { return kernel_exp_approx_taylor_test<CPUType::AVX2>(); }

#ifndef INTGEMM_NO_AVX512
template INTGEMM_AVX512BW void kernel_exp_approx_taylor_test<CPUType::AVX512BW>();
TEST_CASE("Kernel: exp_approx_taylor AVX512BW",) { return kernel_exp_approx_taylor_test<CPUType::AVX512BW>(); }
#endif
